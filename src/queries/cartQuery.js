...
exports.cartInformation = 'select * from cart where cart_id = ? and user_id = ?';
...
exports.checkCart = 'select * from cart where user_id = ?';
exports.createCart = 'insert into cart (cart_id, user_id, cart_createdate) value (?)';
exports.getCartId = 'select cart_id from cart where user_id=?';
