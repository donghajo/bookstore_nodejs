...
exports.orderItem = 'insert into orders (order_id, order_date, order_price, credit_id, credit_expiredate, credit_kind, address_zipcode, address_address_default, address_address_detail, user_user_id) values(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)';
exports.selectOrder = 'select * from orders where order_id = ?';
...
exports.getList = 'select * from orders where user_user_id = ?';
