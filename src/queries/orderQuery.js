exports.orderDetailItem = 'insert into order_detail (order_id, book_id, order_quantity, order_price) values(?,?,?,?)';
exports.orderItem = 'insert into orders (order_id, order_date, order_price, credit_id, credit_expiredate, credit_kind, zipCode, address_default, address_detail, amount, user_id) values(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)';
...
exports.getOrderId = 'select * from orders where user_id=?'
