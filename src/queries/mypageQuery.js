...
exports.updateCard = 'update creditCard set card_id=?, card_expiredate=?, card_kind=? where user_user_id=?'
...
exports.updateAddress = 'update address set zipCode=?, address_default=?, address_detail=? where user_user_id=?'
